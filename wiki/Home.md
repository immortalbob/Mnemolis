...
- **[The Snapshot Engine Bulletproofing Pass](The-Snapshot-Engine-Bulletproofing-Pass)** — five independent bugs found in the background snapshot/diff engine, from a per-source retention gap to a single malformed entity that could crash an entire diff

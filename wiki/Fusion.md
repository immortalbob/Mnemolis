...
For the real bug history behind every mechanism described above — the `[FUSION — FUSION]` double-header bug, the mixed-speed timeout crash, and the seven-finding v3.50.18 investigation — see [The Fusion Merge Bugs](The-Fusion-Merge-Bugs) in full.

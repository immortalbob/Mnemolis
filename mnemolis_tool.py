...
class Tools:
    ...
    def search(self, query: str, source: str = "auto", fusion_sources: list[str] = None) -> str:
        """
        ...
        - changes: What changed today. Use for "what changed today", "any new outages", "what happened".
